...
describe('Raw Content Storage', () => {
  ...
  it('should store raw AI generated content separately from processed content', () => {
    ...
    // 模拟AI生成的原始内容
    const rawContent =
      'You are in a dark forest. There is a **sword** on the ground and a **torch** on the wall.'
    const processedContent =
      'You are in a dark forest. There is a <span class="interactive-word" data-word="sword">sword</span> on the ground and a <span class="interactive-word" data-word="torch">torch</span> on the wall.'
