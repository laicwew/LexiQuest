...
describe('Initial Story Generation and Storage', () => {
  ...
  it('should save initial story to game history when using start prompt', () => {
    ...
    // 模拟初始故事生成
    const initialStory =
      'You stand at the edge of a dense forest. The trees tower above you, their branches forming a canopy that filters the sunlight into dancing patches on the forest floor. A narrow path winds into the shadows ahead. You can hear the distant sound of running water.'
